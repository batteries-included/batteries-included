    ...
    <div className="relative py-16 bg-white sm:py-24 lg:py-32">
      <div className="max-w-md px-4 mx-auto text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
        ...
        <p className="mx-auto mt-5 text-xl text-gray-500 max-w-prose">
          ...
          necessary. When combined correctly they can super charge your
          business; making software fast, stable, and able to predict the
          future. Tech giants know this and invest heavily in their
          infrastructure. Let our teams design, build, and operate the Batteries
          Included platform.
        </p>
        <div className="mt-12">
