defmodule KubeResources.OwnerRefernceTest do
  use ExUnit.Case
  ...
  describe "KubeResources.OwnerRefernce" do
    test "return nil for un owned" do
      assert nil == KubeResources.OwnerReference.get_owner(@empty)
      assert nil == KubeResources.OwnerReference.get_owner(@empty_metadata)
      assert nil == KubeResources.OwnerReference.get_owner(@empty_owner_metadata)
    end

    test "return the uid for an owned" do
      assert "8f92fa99-ea9c-493f-b16d-79ee42770571" ==
               KubeResources.OwnerReference.get_owner(@real_example)
    end
  end
end
