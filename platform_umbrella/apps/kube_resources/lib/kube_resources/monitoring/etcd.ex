defmodule KubeResources.MonitoringEtcd do
        ...
        %{
          ...
          "rules" => [
            ...
            %{
              ...
              "annotations" => %{
                "description" =>
                  "etcd cluster \"{{ $labels.job }}\": {{ $value }} leader changes within the last 15 minutes. Frequent elections may be a sign of insufficient resources, high network latency, or disruptions by other components and should be investigated.",
            ...
            %{
              ...
              "annotations" => %{
                "description" =>
                  "etcd cluster \"{{ $labels.job }}\": 99th percentile of gRPC requests is {{ $value }}s on etcd instance {{ $labels.instance }} for {{ $labels.grpc_method }} method.",
            ...
            %{
              ...
              "annotations" => %{
                "description" =>
                  "etcd cluster \"{{ $labels.job }}\": {{ $value }} proposal failures within the last 30 minutes on etcd instance {{ $labels.instance }}.",
            ...
            %{
              ...
              "annotations" => %{
                "description" =>
                  "etcd cluster \"{{ $labels.job }}\": database size exceeds the defined quota on etcd instance {{ $labels.instance }}, please defrag or increase the quota as the writes to etcd will be disabled when it is full.",
            ...
            %{
              ...
              "annotations" => %{
                "description" =>
                  "etcd cluster \"{{ $labels.job }}\": Predicting running out of disk space in the next four hours, based on write observations within the past four hours on etcd instance {{ $labels.instance }}, please check as it might be disruptive.",
            ...
            %{
              ...
              "annotations" => %{
                "description" =>
                  "etcd cluster \"{{ $labels.job }}\": database size in use on instance {{ $labels.instance }} is {{ $value | humanizePercentage }} of the actual allocated disk space, please run defragmentation (e.g. etcdctl defrag) to retrieve the unused fragmented disk space.",
                "runbook_url" =>
  ...
  resource(:service) do
    ...
    |> B.spec(%{
      "clusterIP" => "None",
      "ports" => [
        %{"name" => "http-metrics", "port" => 2381, "protocol" => "TCP", "targetPort" => 2381}
      ],
