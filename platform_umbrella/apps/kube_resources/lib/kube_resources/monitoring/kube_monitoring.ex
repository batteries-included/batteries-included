defmodule KubeResources.KubeMonitoring do
  ...
  def monitors(config) do
    NodeExporter.monitors(config) ++
      ...
      [
        ...
        kube_controller_monitor(config),
        kube_scheduler_monitor(config),
        kubelet_monitor(config)
      ]
  end

  def apiserver_monitor(config) do
        ...
        %{
          ...
          "metricRelabelings" => [
            %{
              "action" => "drop",
              "regex" =>
                "kubelet_(pod_worker_latency_microseconds|pod_start_latency_microseconds|cgroup_manager_latency_microseconds|pod_worker_start_latency_microseconds|pleg_relist_latency_microseconds|pleg_relist_interval_microseconds|runtime_operations|runtime_operations_latency_microseconds|runtime_operations_errors|eviction_stats_age_microseconds|device_plugin_registration_count|device_plugin_alloc_latency_microseconds|network_plugin_operations_latency_microseconds)",
            ...
            %{
              "action" => "drop",
              "regex" =>
                "apiserver_(request_count|request_latencies|request_latencies_summary|dropped_requests|storage_data_key_generation_latencies_microseconds|storage_transformation_failures_total|storage_transformation_latencies_microseconds|proxy_tunnel_sync_latency_secs|longrunning_gauge|registered_watchers)",
              "sourceLabels" => ["__name__"]
            },
            %{
              "action" => "drop",
            ...
            %{
              "action" => "drop",
              "regex" =>
                "etcd_(helper_cache_hit_count|helper_cache_miss_count|helper_cache_entry_count|object_counts|request_cache_get_latencies_summary|request_cache_add_latencies_summary|request_latencies_summary)",
              "sourceLabels" => ["__name__"]
            },
            %{
              "action" => "drop",
  ...
  def kube_controller_monitor(config) do
    namespace = MonitoringSettings.namespace(config)
  ...
  def kube_scheduler_monitor(config) do
    namespace = MonitoringSettings.namespace(config)
          ...
          %{
            ...
            "metricRelabelings" => [
              ...
              %{
                "action" => "drop",
                "regex" =>
                  "(container_spec_.*|container_file_descriptors|container_sockets|container_threads_max|container_threads|container_start_time_seconds|container_last_seen);;",
