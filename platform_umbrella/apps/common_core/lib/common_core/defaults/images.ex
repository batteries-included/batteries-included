defmodule CommonCore.Defaults.Images do
  @moduledoc false
  @cert_manager_image_tag "v1.14.5"
  ...
  def istio_pilot_image, do: "docker.io/istio/pilot:1.21.2-distroless"
  def istio_proxy_image, do: "docker.io/istio/proxyv2:1.21.2-distroless"
