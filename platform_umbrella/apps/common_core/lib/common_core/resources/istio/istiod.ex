defmodule CommonCore.Resources.Istio.Istiod do
  ...
  resource(:horizontal_pod_autoscaler_istiod, battery, _state) do
    ...
    spec =
      ...
      |> Map.put("scaleTargetRef", %{"apiVersion" => "apps/v1", "kind" => "Deployment", "name" => "istiod"})
  ...
  resource(:mutating_webhook_config_istio_sidecar_injector_battery_istio, battery, _state) do
    ...
    |> B.build_resource()
    |> B.name("istio-sidecar-injector-#{namespace}")
    |> B.label("istio.io/rev", "default")
    |> B.label("istio", "pilot")
  ...
  resource(:validating_webhook_config_istio_validator, battery, _state) do
    namespace = battery.config.namespace
    ...
    |> B.build_resource()
    |> B.name("istio-validator-#{namespace}")
    |> B.label("istio.io/rev", "default")
    |> Map.put("webhooks", webhooks)
  end
