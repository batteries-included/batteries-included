defmodule CommonCore.ApiVersionKind do
  ...
  @known [
    ...
    gateway_backend_tls_policy: {"gateway.networking.k8s.io/v1alpha3", "BackendTLSPolicy"},
    ...
    gateway_tcp_route: {"gateway.networking.k8s.io/v1alpha2", "TCPRoute"},
    gateway_tls_route: {"gateway.networking.k8s.io/v1alpha2", "TLSRoute"},
    gateway_udp_route: {"gateway.networking.k8s.io/v1alpha2", "UDPRoute"},
    ...
    karpenter_aksnode_class: {"karpenter.azure.com/v1beta1", "AKSNodeClass"},
