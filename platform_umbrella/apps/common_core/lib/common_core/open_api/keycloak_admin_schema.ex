defmodule CommonCore.OpenAPI.KeycloakAdminSchema do
  ...
  defmodule ClientPolicyExecutorRepresentation do
    ...
    batt_embedded_schema do
      field :configuration, {:array, :string}
  ...
  defmodule ResourceRepresentation do
    ...
    batt_embedded_schema do
      ...
      field :name, :string
      embeds_many :owner, ResourceOwnerRepresentation
      field :ownerManagedAccess, :boolean
      embeds_many :scopes, ScopeRepresentation
      embeds_many :scopesUma, ScopeRepresentation
      field :type, :string
      field :uri, :string
  ...
  defmodule MemberRepresentation do
    ...
    batt_embedded_schema do
      ...
      embeds_one :membershipType, MembershipType
  ...
  defmodule UPConfig do
    ...
    batt_embedded_schema do
      ...
      embeds_one :unmanagedAttributePolicy, UnmanagedAttributePolicy
    end
  end
  ...
  defmodule ResourceOwnerRepresentation do
    @moduledoc false
    use CommonCore, :embedded_schema
  ...
  defmodule AbstractPolicyRepresentation do
    ...
    batt_embedded_schema do
      embeds_one :decisionStrategy, DecisionStrategy
      field :description, :string
      field :id, :string
      embeds_one :logic, Logic
      field :name, :string
      field :owner, :string
      field :policies, {:array, :string}
      field :resources, {:array, :string}
      embeds_many :resourcesData, ResourceRepresentation
      field :scopes, {:array, :string}
      embeds_many :scopesData, ScopeRepresentation
      field :type, :string
    end
  end
  ...
  defmodule MethodConfig do
    ...
    batt_embedded_schema do
      field :method, :string
      field :scopes, {:array, :string}
      embeds_one :"scopes-enforcement-mode", ScopeEnforcementMode
    end
  end
  ...
  defmodule PathConfig do
    ...
    batt_embedded_schema do
      ...
      embeds_one :"enforcement-mode", EnforcementMode
      field :id, :string
  ...
  defmodule PolicyEnforcerConfig do
    ...
    batt_embedded_schema do
      ...
      field :realm, :string
      field :resource, :string
      embeds_one :"user-managed-access", UserManagedAccessConfig
    end
  end
  ...
  defmodule PolicyResultRepresentation do
    ...
    batt_embedded_schema do
      ...
      embeds_one :policy, PolicyRepresentation
      field :scopes, {:array, :string}
      embeds_one :status, DecisionEffect
    end
  end
  ...
  defmodule EvaluationResultRepresentation do
    ...
    batt_embedded_schema do
      embeds_many :allowedScopes, ScopeRepresentation
      embeds_many :policies, PolicyResultRepresentation
      embeds_one :resource, ResourceRepresentation
      embeds_many :scopes, ScopeRepresentation
      embeds_one :status, DecisionEffect
    end
  end
  ...
  defmodule ResourceServerRepresentation do
    ...
    batt_embedded_schema do
      ...
      field :name, :string
      embeds_many :policies, PolicyRepresentation
      embeds_one :policyEnforcementMode, PolicyEnforcementMode
      embeds_many :resources, ResourceRepresentation
      embeds_many :scopes, ScopeRepresentation
    end
  end
  ...
  defmodule RealmRepresentation do
    ...
    batt_embedded_schema do
      ...
      embeds_one :bruteForceStrategy, BruteForceStrategy
      field :certificate, :string
