...
defmodule CommonCore.Actions.VMCluster do
  ...
  def materialize(%SystemBattery{} = system_battery, %StateSummary{} = state_summary) do
    [ensure_vm_cluster_client(system_battery, state_summary)]
  end

  defp ensure_vm_cluster_client(%SystemBattery{} = battery, %StateSummary{keycloak_state: key_state} = summary) do
