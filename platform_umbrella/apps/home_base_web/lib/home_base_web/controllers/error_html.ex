defmodule HomeBaseWeb.ErrorHTML do
  ...
  def render("404.html", assigns) do
    ...
    <html lang="en">
      ...
      <body class="antialiased min-h-screen background-gradient grid grid-cols-1 lg:grid-cols-2 justify-items-center lg:gap-36 p-12">
