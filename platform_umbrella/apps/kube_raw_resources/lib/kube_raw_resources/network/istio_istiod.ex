defmodule KubeRawResources.IstioIstiod do
  ...
  resource(:cluster_role_binding_istio_reader_clusterrole_battery_istio, config) do
  ...
  resource(:cluster_role_binding_istiod_clusterrole_battery_istio, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:cluster_role_binding_istiod_gateway_controller_battery_istio, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:config_map_istio, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:config_map_istio_sidecar_injector, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:deployment_istiod, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:horizontal_pod_autoscaler_istiod, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:istio_envoy_filter_stats_1_13, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:istio_envoy_filter_stats_1_14, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:istio_envoy_filter_stats_1_15, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:istio_envoy_filter_tcp_stats_1_13, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:istio_envoy_filter_tcp_stats_1_14, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:istio_envoy_filter_tcp_stats_1_15, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:mutating_webhook_config_istio_sidecar_injector_battery_istio, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:pod_disruption_budget_istiod, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:role_binding_istiod, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:role_istiod, config) do
    namespace = Settings.istio_namespace(config)
  ...
  resource(:service_istiod, config) do
    namespace = Settings.istio_namespace(config)
