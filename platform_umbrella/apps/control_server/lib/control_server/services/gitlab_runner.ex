defmodule ControlServer.Services.GitlabRunner do
  @moduledoc false
            ...
            "initContainers" => [
              %{
                ...
                "env" => [
                  ...
                  %{"name" => "CLONE_URL", "value" => ""},
                  %{"name" => "RUNNER_REQUEST_CONCURRENCY", "value" => "1"},
                  %{"name" => "RUNNER_EXECUTOR", "value" => "kubernetes"},
                  %{"name" => "REGISTER_LOCKED", "value" => "true"},
                  %{"name" => "RUNNER_TAG_LIST", "value" => ""},
                  %{"name" => "KUBERNETES_IMAGE"},
                  %{"name" => "KUBERNETES_NAMESPACE", "value" => "battery-devtools"},
                  %{"name" => "KUBERNETES_CPU_LIMIT", "value" => ""},
                  %{"name" => "KUBERNETES_CPU_LIMIT_OVERWRITE_MAX_ALLOWED", "value" => ""},
                  %{"name" => "KUBERNETES_MEMORY_LIMIT", "value" => ""},
                  %{"name" => "KUBERNETES_MEMORY_LIMIT_OVERWRITE_MAX_ALLOWED", "value" => ""},
                  %{"name" => "KUBERNETES_CPU_REQUEST", "value" => ""},
                  %{"name" => "KUBERNETES_CPU_REQUEST_OVERWRITE_MAX_ALLOWED", "value" => ""},
                  %{"name" => "KUBERNETES_MEMORY_REQUEST", "value" => ""},
                  %{"name" => "KUBERNETES_MEMORY_REQUEST_OVERWRITE_MAX_ALLOWED", "value" => ""},
                  %{"name" => "KUBERNETES_SERVICE_ACCOUNT", "value" => ""},
                  %{"name" => "KUBERNETES_SERVICE_CPU_LIMIT", "value" => ""},
                  %{"name" => "KUBERNETES_SERVICE_MEMORY_LIMIT", "value" => ""},
                  %{"name" => "KUBERNETES_SERVICE_CPU_REQUEST", "value" => ""},
                  %{"name" => "KUBERNETES_SERVICE_MEMORY_REQUEST", "value" => ""},
                  %{"name" => "KUBERNETES_HELPER_CPU_LIMIT", "value" => ""},
                  %{"name" => "KUBERNETES_HELPER_MEMORY_LIMIT", "value" => ""},
                  %{"name" => "KUBERNETES_HELPER_CPU_REQUEST", "value" => ""},
                  %{"name" => "KUBERNETES_HELPER_MEMORY_REQUEST", "value" => ""},
                  %{"name" => "KUBERNETES_HELPER_IMAGE", "value" => ""},
                  %{"name" => "KUBERNETES_PULL_POLICY", "value" => ""}
                ],
                "volumeMounts" => [
