defmodule HomeBase.Projects.StaticProjects do
  ...
  use CommonCore.IncludeResource,
    ...
    serverless_v0: "priv/stored_projects/batt_019741bce3157609b800f611baa82b9a.json"

  def static_projects(install_id \\ nil) do
    Map.new(
      [{"batt_0197313f7c447c85ab2462d284f01077", :rag_v0}, {"batt_019741bce3157609b800f611baa82b9a", :serverless_v0}],
      fn {id, resource} ->
