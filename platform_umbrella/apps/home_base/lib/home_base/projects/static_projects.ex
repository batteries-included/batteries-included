defmodule HomeBase.Projects.StaticProjects do
  ...
  use CommonCore.IncludeResource,
    ...
    ai_open_web_ui_with_rag_v0: "priv/stored_projects/batt_01977a8660a17fb69f8f62fb3309da44.json",
  ...
  def static_projects(install_id \\ nil) do
    Map.new(
      [
        ...
        {"batt_01977a8660a17fb69f8f62fb3309da44", :ai_open_web_ui_with_rag_v0},
